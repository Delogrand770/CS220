...
/**
 ...
 the programmer to easily get user mouse and keyboard inputs.
...
public class DrawingPanel extends Thread implements MouseInputListener, KeyListener {
  ...
  //----------------------------------------------------------------------------  
   ...
   that is drawing to the window can be paused and restarted (never
  ...
  /**
   ...
   <p>The integer values represents the key that was pressed (and not the
   upper or lower case of the key). <ul> <li>For the digits, the codes
   are equivalent to the Unicode character '0' - '9'</li> <li>For the
   characters, the codes are equivalent to the Unicode characters 'A' -
   'Z' (NOTE: CAPITAL LETTERS)</li> <li>For the function keys, use the
   named constants F1_KEY, ... F12_KEY</li> <li>For the other special
   keys, use: <ul> <li> DrawingPanel.LEFT_ARROW_KEY </li> <li>
