...
/**
 Description: This class implements the Connect Four User Interface. In
 this implementation, it uses the DrawingPanel class for all user
 interaction.
...
public class ConnectFourUI {
  ...
  /**
   The constructor creates and opens the DrawingPanel object and sets up
   the Graphics and FontMetrics objects for future use.
   */
  ...
  /**
   Uses the DrawingPanel's mouse click method to wait for a click, then
   calculates and returns the column that was clicked.
